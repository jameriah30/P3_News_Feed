...
define('VIRTUAL_PATH', 'http://jameriah.com/itc250/wn16/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/hermes/bosnaweb05a/b264/ipg.jameriahcom/itc250/wn16/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'jsmit028@seattlecentral.edu'); # Email of site support
define('PREFIX', 'sm15_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
